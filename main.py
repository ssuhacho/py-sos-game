...
class SOS(FloatLayout, App):
    ...
    def __init__(self, **kwargs):
        ...
        self.gamenametv = Label(text='SOS Game',
                                ...
                                color=(0.207, 0.635, 0.423, 0.9))
        self.start_btn_simple = Button(text='Simple game',
                                size_hint=(.15, .1),
                                pos_hint={'center_x': .5, 'center_y': .625},
                                on_release=lambda x: self.two_player_popup())
        self.start_btn_general = Button(text='General game',
                                size_hint=(.15, .1),
        ...
        self.add_widget(self.start_btn_simple)
        self.add_widget(self.start_btn_general)
        ...
        self.creategamecontent.boardSize.size_hint = (None, None)
        self.creategamecontent.boardSize.size = (552,50)
    ...
    def on_start_pressed(self, instance):
        ...
        self.remove_widget(self.start_btn_simple)
        self.remove_widget(self.start_btn_general)
...
class CreateGameLayout(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.boardSize = BoxLayout(orientation='horizontal')
        ...
        self.boardSizeInstruction = Label(text='Type board size: ',
                                      font_size=25,
                                      color=(1, 1, 1, 1))
        self.boardSizeInput = TextInput(multiline=False)
        self.boardSize.add_widget(self.boardSizeInstruction)
        self.boardSize.add_widget(self.boardSizeInput)
        self.add_widget(self.boardSize)
